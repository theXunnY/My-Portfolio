...
const Hero = () => {
  ...
  return (
    <section className='flex min-h-screen flex-col items-center justify-center gap-4 lg:gap-6' ref={heroRef}>
      ...
      <a href="/src/public/SunnY.pdf" target='_blank' rel='noopener noreferrer' download className='hero-btn mb-6 flex gap-1 rounded-full border border-pink-200/50 px-3 py-2 tracking-tighter'>
